...
/**
 * 실시간 스크래핑 진행상황 표시 컴포넌트
 */
export function ScrapingProgress({ skillId }: ScrapingProgressProps) {
        ...
        {skill.status === "completed" && (
          <div className="bg-green-50 border border-green-200 rounded-lg p-4">
            <div className="flex items-center gap-2 mb-2">
              ...
              <p className="font-semibold text-green-900">스킬 생성 완료!</p>
            </div>
        ...
        {skill.status === "failed" && (
          <div className="bg-red-50 border border-red-200 rounded-lg p-4">
            <div className="flex items-center gap-2 mb-2">
              ...
              <p className="font-semibold text-red-900">스크래핑 실패</p>
            </div>
